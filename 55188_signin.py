...
def sign_in(cookie_str):
    ...
    session.headers.update({
        ...
        "Referer": "https://55188.com/plugin.php?id=sign",
    ...
    r1 = session.get("https://55188.com/plugin.php?id=sign")
    ...
    if '您好，游客！' in html or '安全验证' in html:
        ...
        if 'id="addsign"' not in html:
            ...
            msg2 = "❌ 今天还未签到，准备签到...\n"
            time.sleep(1)
            r2 = session.get("https://55188.com/plugin.php?id=sign&mod=add&jump=1")
